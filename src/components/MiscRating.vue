...
<!--                                    </div>-->
<!--                                    <div>{{m.directors}}</div>-->
<!--                                    &lt;!&ndash;                        <div>({{movie.shoot}})</div>&ndash;&gt;-->
<!--                                </div>-->
<!--                            </v-card-title>-->
<!--                        </v-col>-->
<!--                        <v-img-->
...
<!--                        给电影打分-->
<!--                        <v-spacer></v-spacer>-->
<!--                        <span class="black&#45;&#45;text text&#45;&#45;lighten-2 caption mr-2">({{ movie.score }})</span>-->
<!--                        <v-rating-->
<!--                          background-color="#737373"-->
<!--                          color="yellow accent-4"-->
<!--                          dense-->
...
<script>
    ...
    export default {
        ...
        //         console.log("movie.score changed")
        //         console.log(this.fatherMethod)
        //         if(this.fatherMethod) {
        //             this.fatherMethod(this.movie, newVal)
        //         }
        //         // if (this.first) {
        //         //     this.first = false;
        //         //     return
